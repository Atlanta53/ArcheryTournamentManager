...
/*
 *  Description : Class that show the dialog for a modification
 *  Entry : The props inscriptions with the inscription list and the index selected and information to open the dialog
 *  Exit : The dialog
 */
export class DialogListCompetition extends React.Component {
